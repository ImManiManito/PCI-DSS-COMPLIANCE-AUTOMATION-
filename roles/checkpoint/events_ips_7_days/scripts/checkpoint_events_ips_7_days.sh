#!/usr/bin/env bash
# Igual a checkpoint_events_ips.sh pero cubre los últimos 7 días (rolling window).
...
# 2) Consulta paginada de eventos IPS de los últimos 7 días, trayendo todos los resultados.
PAGE_TOKEN=""
